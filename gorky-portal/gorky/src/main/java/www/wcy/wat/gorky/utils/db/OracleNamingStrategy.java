package www.wcy.wat.gorky.utils.db;
...
public class OracleNamingStrategy extends DefaultComponentSafeNamingStrategy
{
    ...
    {
        return abbreviateName( super.tableName( addUnderscores( tableName ) ) );
    }

    @Override
    public String columnName( String columnName )
    {
        return abbreviateName( super.columnName( addUnderscores( columnName ) ) );
    }

    @Override
    public String joinKeyColumnName( String joinedColumn, String joinedTable )
    {
        return abbreviateName( super.joinKeyColumnName(
